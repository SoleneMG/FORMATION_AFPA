...
public static void main( String [] args ){
	...
	Entreprise entreprise1 = new Entreprise("Entreprise1");
	...
	try {
		entreprise1.addSalaries(salarie1);
		entreprise1.addSalaries(salarie2);
		entreprise1.addSalaries(salarie3);
		entreprise1.addSalaries(salarie1);
	} catch (SalarieException e) {
		System.out.println(e);
	}
	...
	entreprise1.getSalaries().forEach(System.out::println);
	System.out.println();
}}