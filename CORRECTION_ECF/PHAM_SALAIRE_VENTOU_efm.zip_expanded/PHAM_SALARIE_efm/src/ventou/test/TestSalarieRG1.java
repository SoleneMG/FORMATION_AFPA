...
public class TestSalarieRG1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n------------------------------");
		System.out.println("On augmente Dupond de 50\n ");
		try {
			dupond.augmente(50);
		...
		System.out.println("\n------------------------------");
		System.out.println("On demissionne Durand\n ");
		durand.demissionne();
		System.out.println(durand);

		System.out.println("\n------------------------------");
		System.out.println("On augmente Durand de 100\n ");
